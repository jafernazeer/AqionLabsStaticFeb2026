...
export const INDUSTRY_DATA: Record<string, IndustryPageData> = {
  ...
  [PageType.INDUSTRY_GOVERNMENT]: {
    ...
    solutions: {
      aqionVox: [
        "Aqion Voice Citizen enquiry automation"
      ],
      enterpriseAi: [
  ...
  [PageType.INDUSTRY_FINANCE]: {
    ...
    ctaText: "Infographic showing how Aqion Voice will help the Financial sector industry to deal with customer enquiries"
  },
  [PageType.INDUSTRY_HOSPITALITY]: {
    ...
    ctaText: "Infographic showing how Aqion Voice will help the hospitality industry to deal with customer enquiries"
  },
  [PageType.INDUSTRY_LOGISTICS]: {
    ...
    ctaText: "Infographic showing how Aqion Voice will help the Logistics & Transportation Firms to deal with customer service"
  },
...
export const PRODUCT_DATA: Record<string, DetailPageData> = {
  [PageType.PRODUCT_AQIONVOX]: {
    ...
    sections: [
        {
            title: "What It Is",
            content: "Aqion Voice is a flagship all-in-one AI workforce platform. It combines voice capabilities, WhatsApp automation, and CRM intelligence into a single entity that acts as your best employee—one that never sleeps."
        }
    ],
    howAiIsLeveraged: [
