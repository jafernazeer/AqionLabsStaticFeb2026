...
const Privacy: React.FC = () => {
  ...
  return (
    <div className="mesh-bg min-h-screen text-ink pt-32 pb-20 font-sans relative">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <h2 className="text-2xl md:text-3xl font-bold mb-8 text-petrol display-italic">PRIVACY POLICY</h2>
        <p className="text-taupe mb-8"><strong>Last Updated:</strong> 2/12/2026</p>
        
        <div className="prose prose-lg prose-invert text-taupe max-w-none space-y-8">
            {/* 1. Introduction */}
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">1. Introduction</h3>
            ...
            {/* 2. Legal Framework */}
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">2. Legal Framework</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">3. Personal Data We Collect</h3>
                <p>We may collect and process the following categories of personal data:</p>
                
                <div className="ml-4 mt-4 space-y-4">
                    <div>
                        <strong className="text-ink block mb-2">3.1 Usage Data</strong>
                    ...
                    <div>
                        <strong className="text-ink block mb-2">3.2 Account Information</strong>
                    ...
                    <div>
                        <strong className="text-ink block mb-2">3.3 Transaction Information</strong>
                    ...
                    <div>
                        <strong className="text-ink block mb-2">3.4 Communication Data</strong>
                    ...
                    <div>
                        <strong className="text-ink block mb-2">3.5 Marketing & Subscription Data</strong>
                    ...
                    <div>
                        <strong className="text-ink block mb-2">3.6 AI Interaction Data</strong>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">4. Legal Basis for Processing</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">5. How We Use Personal Data</h3>
                ...
                <p className="mt-4 font-semibold text-ink">We do not sell personal data.</p>
            </section>

            {/* 6. Sharing of Personal Data */}
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">6. Sharing of Personal Data</h3>
                <p>We may share personal data with:</p>
                <div className="ml-4 mt-4 space-y-4">
                     <div>
                        <strong className="text-ink block mb-2">6.1 Affiliates</strong>
                        <p>Companies within the AqionLabs group where necessary for operational purposes.</p>
                    </div>
                    <div>
                        <strong className="text-ink block mb-2">6.2 Service Providers</strong>
                    ...
                    <div>
                        <strong className="text-ink block mb-2">6.3 Legal Authorities</strong>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">7. International Transfers</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">8. Cookies & Tracking Technologies</h3>
                <div className="ml-4 mt-4 space-y-4">
                    <div>
                        <strong className="text-ink block mb-2">8.1 What Are Cookies?</strong>
                        <p>Cookies are small text files placed on your device to improve website functionality and analytics.</p>
                    </div>
                    <div>
                        <strong className="text-ink block mb-2">8.2 How We Use Cookies</strong>
                        <p>We may use:</p>
                        <ul className="list-disc pl-6 space-y-1 mt-2">
            ...
            {/* 9. Analytics */}
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">9. Analytics</h3>
            ...
            {/* 10. Data Retention */}
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">10. Data Retention</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">11. Your Rights Under UAE PDPL</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">12. Children’s Privacy</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">13. Security Measures</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">14. AI-Specific Privacy Notice</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">15. Updates to This Privacy Policy</h3>
            ...
            <div className="border-t border-hairline pt-8 mt-12">
                <h3 className="text-xl font-bold text-ink mb-4">16. Contact Us</h3>
                <p>If you have questions about this Privacy Policy or your personal data:</p>
                <p className="mt-4 font-semibold text-ink">AqionLabs</p>
                <p>United Arab Emirates</p>
                <p>Support: <a href="mailto:connect@aqionlabs.ai" className="text-petrol hover:underline">connect@aqionlabs.ai</a></p>
            </div>
        </div>
      </div>
    </div>
