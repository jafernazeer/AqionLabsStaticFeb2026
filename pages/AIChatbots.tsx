          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              ...
              <p className="mobile-clamp-3 text-base md:text-lg text-graphite leading-relaxed mb-8">
                Conventional chatbots are reactive—they wait for customers to type. <strong className="text-petrol display-italic">Aqion Vox</strong> is a proactive AI workforce. It speaks, it texts on WhatsApp, and it closes deals autonomously.
              </p>
