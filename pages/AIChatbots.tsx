        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
            <div>
              ...
              <h2 className="text-[2.45rem] leading-tight md:text-4xl font-bold text-ink mb-6">Need More Than Just Text? Upgrade to <span className="text-petrol display-italic">AqionVox</span></h2>
              <p className="mobile-clamp-3 text-base md:text-lg text-graphite leading-relaxed mb-8">
                Conventional chatbots are reactive—they wait for customers to type. <strong className="text-petrol display-italic">AqionVox</strong> is a proactive AI workforce. It speaks, it texts on WhatsApp, and it closes deals autonomously.
              </p>
