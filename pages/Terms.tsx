      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        ...
        <div className="prose prose-lg prose-invert text-taupe max-w-none space-y-8">
            <section>
                ...
                <p className="pl-4 border-l-2 border-petrol/50 my-4">
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">1. DEFINITIONS</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">2. SCOPE OF SERVICES</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">3. TERM AND TERMINATION</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">4. FEES AND PAYMENT</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">5. DATA PROTECTION & SECURITY</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">6. CUSTOMER OBLIGATIONS</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">7. AI-SPECIFIC PROVISIONS</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">8. SUBPROCESSORS</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">9. CONFIDENTIALITY</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">10. WARRANTIES AND DISCLAIMERS</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">11. LIMITATION OF LIABILITY</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">12. INDEMNIFICATION</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">13. FORCE MAJEURE</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">14. GOVERNING LAW & DISPUTE RESOLUTION</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">15. INTELLECTUAL PROPERTY</h3>
            ...
            <section>
                <h3 className="text-xl font-bold text-ink mb-4">16. MODIFICATION OF TERMS</h3>
                <p>AqionLabs may update this Agreement. Updates will be effective upon posting. Continued use constitutes acceptance.</p>
            </section>

            <section>
                <h3 className="text-xl font-bold text-ink mb-4">17. ENTIRE AGREEMENT</h3>
            ...
            <div className="border-t border-hairline pt-8 mt-12">
                <h3 className="text-xl font-bold text-ink mb-4">CONTACT</h3>
